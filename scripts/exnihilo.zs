...
// --- Ingots ---
<ore:ingotYellorium>.add(<exnihiloomnia:ore_yellorite_ingot>);
...
<ore:ingotOsmium>.add(<exnihiloomnia:ore_osmium_ingot>);
<ore:ingotNickel>.add(<exnihiloomnia:ore_nickel_ingot>);
<ore:ingotLead>.add(<exnihiloomnia:ore_lead_ingot>);
<ore:ingotDraconium>.add(<exnihiloomnia:ore_draconium_ingot>);
